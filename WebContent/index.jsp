...
<title>QLDH - Java-Intern02</title>

<!-- Custom fonts for this template-->
<link href="asserts/vendor/fontawesome-free/css/all.min.css"
...
<body id="page-top">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-cog"></i> <span>User Manage</span>
			</a>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseUtilities"> <i
					class="fas fa-fw fa-wrench"></i> <span>Student Manage</span>
			</a>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapsePages"> <i
					class="fas fa-fw fa-folder"></i> <span>Subject Manage</span>
			</a>
	...
	<!-- Page level plugins -->
	<script src="asserts/vendor/chart.js/Chart.min.js"></script>

	<!-- Page level custom scripts -->
	<script src="asserts/js/demo/chart-area-demo.js"></script>
	<script src="asserts/js/demo/chart-pie-demo.js"></script>
