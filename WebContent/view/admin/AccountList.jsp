						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered text-center" id="dataTable"
									...
									<tbody>
										<% for(Account a : dao.getFullAccount()){ %>
											<tr>
												<td><%= a.getUsername() %></td>
												<td><%= a.getStudent().getId() %></td>
												<td><%= a.getRole() %></td>
												<td>
												<% if(account.getUsername().equals(a.getUsername()) || a.getRole().equals("student") ){ %>
												<div class="d-inline-flex">
														<a class="btn btn btn-primary"
															href="admin-account-update?username=<%= a.getUsername() %>">
															<!-- <i class="fas fas fa-edit fa-fw mr-2 text-gray-400"></i> -->
															Sửa
														</a> <a class="btn btn btn-danger ml-2"
															href="admin-account-delete?username=<%= a.getUsername() %>">
