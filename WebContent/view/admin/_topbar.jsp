...
<nav
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			role="button" data-toggle="dropdown" aria-haspopup="true"
			aria-expanded="false"> <c:if test="${not empty ACCOUNT}">
					<span class="mr-2 d-none d-lg-inline text-gray-600 small">Chào,
						${ACCOUNT.username}</span>
				</c:if> <img class="img-profile rounded-circle"
			...
			<div
				...
				<a class="dropdown-item" href="#"> <i
					...
					class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> Nhật ký
					hoạt động
				</a>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">Chọn "Thoát" để rời đi. Nhớ quay lại
				nhé!!!</div>
