				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h2 class="m-0 font-weight-bold text-primary">Bảng Điểm</h2>
							<div align="right" style="margin-bottom: -48px;">
								<a href="admin-mark-add" class="btn btn-primary"
									style="margin-right: 15px; margin-bottom: 38px"> Nhập điểm</a>
							</div>
						</div>
						<div class="card-body">
											...
											<tr>
												...
												<td><div class="d-inline-flex">
														<a class="btn btn btn-primary"
															href="admin-mark-update?studentId=${mark.student.id}&subjectId=${mark.subject.id}">
															<!-- <i class="fas fas fa-edit fa-fw mr-2 text-gray-400"></i> -->
															Sửa
														</a> <a class="btn btn btn-danger ml-2"
															href="admin-mark-delete?studentId=${mark.student.id}&subjectId=${mark.subject.id}">
