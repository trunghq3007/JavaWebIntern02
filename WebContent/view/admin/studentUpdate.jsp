		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<form class="user" action="admin-student-update" method="post">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-6">
									<select name="birth_place " value="${student.birthPlace}"
							...
							<div class="row">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="class_id"
										required value="${student.classroom.id}" readonly="readonly">
								</div>
								<div class="col-md-3"></div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<button type="submit" name="action" value="add"
										class="btn btn btn-primary btn-lg ">Sửa</button>
								</div>
								<div class="col-md-3"></div>
							</div>
					</form>
